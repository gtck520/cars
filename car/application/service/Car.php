...
class Car
{
    ...
    public static function add($user_id, $req)
    {
        ...
        //排量表
        $pl = CarPLModel::where(['pailiang' => $req['DisplacementWithT']])->find();
        if (!$pl) {
            CarPLModel::insert([
                'pailiang' => $req['DisplacementWithT']
            ]);
        }
