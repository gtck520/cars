 ...
 * Class Rsa
 * @package king\lib
 * 默认为公钥加密,私钥解密,如果要用要用私钥加密,公钥解密,调用publicDecrypt,privateEncrypt
 */
class Rsa
{
    private $public_key;
    ...
    public static function getClass($public_key_file = '', $private_key_file = '', $open_ssl_path = '')
    {
        return new Rsa($public_key_file, $private_key_file, $open_ssl_path);
    }
