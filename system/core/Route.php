...
class Route
{
    ...
    public static function getSegs($uri = '')
    {
        self::$route = C('route.*');
    ...
    {
        $seg_str = route::pregUrl(implode('/', self::$seg_uri));
